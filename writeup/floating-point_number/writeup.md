...
1.implementation hexadecimal floating-point literal trong C

- 2.Số thực theo hệ cơ số 16 (hexdecimal)
...
1.Ép kiểu số thực và biểu diễn nhị phân khi ép kiểu số thực
